...
public class VehicleForm extends JFrame implements ActionListener 
{
    ...
    public void actionPerformed(ActionEvent e) 
    {
        try 
        {
            ...
            Vehicle v = null;   // Upcasting reference
    ...
    private void showBasicInfo()
    {
        ...
        String name = JOptionPane.showInputDialog(this, "Enter Vehicle Name:");
        if (name == null || name.trim().isEmpty()) return;

        Vehicle v = getVehicleByName(name.trim());
    ...
    private void runVehicleOperation()
    {
        ...
        {
            Car c = (Car) v;
            displayArea.append("Car Range: " + c.calculateRange() + " km\n");
        }
        else if (v instanceof Bike)
        {
            Bike b = (Bike) v;
            displayArea.append("Bike Travel Time: " + b.calculateTravelTime() + " hours\n");
        }
    }
    ...
    private void checkVehicleType()
    {
        ...
        if (v instanceof Car)
        {
            displayArea.append("Vehicle Type: Car\n");
        }
        else if (v instanceof Bike)
        {
            displayArea.append("Vehicle Type: Bike\n");
        }
        else
        {
            displayArea.append("Vehicle Type: Unknown Type\n");
        }
    }
