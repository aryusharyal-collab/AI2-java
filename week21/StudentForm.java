...
public class StudentForm extends JFrame implements ActionListener
{
    ...
    private JPanel titlePanel, sidebarPanel, formPanel, resultPanel, advancedEventPanel, elementPanel, dragPanel;
    ...
    public StudentForm()
    {
        ...
        txtField.addFocusListener(new FocusAdapter()
        {
            ...
            {
                if(txtField.getText().equals("Enter your name"))
                {
                    txtField.setText("");
                }
            }
        ...
        txtField.addKeyListener(new KeyAdapter()
        {
            ...
            {
                int count = txtField.getText().length();
                countLabel.setText("Charachter count is "+count);
            }
        }
        );
        ...
        clearFormBtn.setForeground(Color.BLACK);
        ...
        advancedEventPanel.add(dragPanel);
